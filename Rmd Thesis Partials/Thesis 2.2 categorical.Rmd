...
y <- factor(y, levels = 1:6, labels = c("NoVol", "LowVol", "BelowAvgVol", "AverageVol", "AboveAvgVol", "HighVol"))
...
train_data <- df_scaled[train_index, ]
test_data  <- df_scaled[-train_index, ]
class_levels <- c("NoVol", "LowVol", "BelowAvgVol", "AverageVol", "AboveAvgVol", "HighVol")
```
